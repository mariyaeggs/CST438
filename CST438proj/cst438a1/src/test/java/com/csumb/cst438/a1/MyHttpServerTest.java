 ...
 * @version 1.0 last update 3-21-2017
 */
public class MyHttpServerTest {
    ...
    /**
     * Test of main method, of class MyHttpServer. Test for successful download
     * of h1.gif
     */
    @Test
    public void testHandle() {
        ...
        try {
            ...
            String expectedBody = "<!DOCTYPE html><html><head><title>MyHttpServer</title></head>"
                    ...
                    + handler.setupAGame().getDisplayWord() + "</h2><form action=\"/\" method=\"get\"> Guess a character <input type=\"text\" name=\"guess\"><br>"
